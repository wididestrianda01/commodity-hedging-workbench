...
term is the per-bucket default density). On this book: \usd{}583.79.
The same input re-quoted by QuantLib \cite{quantlib} agrees to
$1.9\times10^{-16}$ relative --- machine-precision agreement on a
re-derivation, the strongest single check in the suite.
\end{concept}
